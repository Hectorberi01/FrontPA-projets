              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t">
                  <div>
                    ...
                    <p className="mt-1">{projet.dateCreation}</p>
                  </div>
                  <div>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center justify-between py-2 border-b">
                  ...
                  <span className="font-medium">{projet.groupes.length}</span>
                </div>
                <div className="flex items-center justify-between py-2 border-b">
                  <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">{projet.livrables.length}</span>
                </div>
                <div className="flex items-center justify-between py-2 border-b">
                  <div className="flex items-center gap-2">
                ...
                <div className="flex items-center justify-between py-2">
                  ...
                  <span className="font-medium">{projet.soutenances.date}</span>
                </div>
              </div>
            </CardContent>
          </Card>
                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-6 flex justify-end gap-4">
                    <Button variant="outline" asChild>
                      <Link href={`/projets/${projet.id}/soutenances/planning`}>Voir planning</Link>
                    </Button>
                    <Button asChild>
                      <Link href={`/projets/${projet.id}/soutenances/edit`}>Modifier</Link>
                    </Button>
                  </div>
                </div>
              </CardContent>
